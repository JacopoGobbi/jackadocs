...
[Here](https\:\/\/github\.com\/jackadull\/jackadocs\/blob\/release\/latest\/docs\/src\/main\/scala\/net\/jackadull\/jackadocs\/docs\/readme\/Ch2\_IntendedUse\.scala) is an example for the Scala source file from which this text is generated\.
